...
- tetragon-009: `tetragon/configs/tracepoint-vs-kprobe-policies.yaml` — Comparing Tetragon tracing-policy approaches: tracepoint-based exec monitoring vs kprobe-based file-permission monitoring with mechanism trade-offs (L3 config)

## 2026-09-23

### Added

- docker-015: `docker/docs/cicd-end-to-end.md` — Docker integration CI/CD end-to-end: build once with commit tag, smoke-test before push, deploy by tested tag (L4 docs)
...
- ansible-010: `ansible/docs/wired-ansible-infrastructure-workflow.md` — Wiring Ansible into an infrastructure workflow: site.yml + roles layout, galaxy scaffold, per-family includes (L3 docs)
...
- Passed ([x]) defectdojo-004 — defectdojo: notes — Follow the official defectdojo quickstart and write up what tripped me up · Level: L2 · 2026-09-21
...
- defectdojo-005: `defectdojo/configs/2026-09-21-vulnerability-scanner-setup.yaml` — Minimal DefectDojo vulnerability scanner integration config (L2 config, rework of #593)
...
- codeql-014: `codeql/templates/custom-query-pack-ci-harness/` — CodeQL custom query pack scaffold with CI integration harness (L5 template)
...
### Reworked
- checkov-022: `checkov/docs/checkov-v3-upgrade-checklist.md` — rework: removed unsupported version-specific migration, API, authentication, and output claims; retained a release-specific checklist with baseline comparison and rollback guidance (L6 docs)
