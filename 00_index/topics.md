...
- **scripts** (3): [analyze-trufflehog-results.py](../trufflehog/scripts/analyze-trufflehog-results.py), [multi-repo-scan-pipeline.sh](../trufflehog/scripts/multi-repo-scan-pipeline.sh), [pre-commit-scan-pipeline.sh](../trufflehog/scripts/pre-commit-scan-pipeline.sh)
- **templates** (16): [secret-scanning-pipeline](../trufflehog/templates/secret-scanning-pipeline/), [multi-repo-secret-scan](../trufflehog/templates/multi-repo-secret-scan/), [github-secret-scanning-integration](../trufflehog/templates/github-secret-scanning-integration/)
...
- **templates** (14): [zap-dast-integration-scaffold](../zap/templates/zap-dast-integration-scaffold/), [zap-dast-integration](../zap/templates/zap-dast-integration/)
- _…and more under `zap/` — browse the folder._

## Checkov · 30 files
- **primer:** [0000-primer-checkov.md](../checkov/notes/0000-primer-checkov.md)
- **notes** (4): most recent → [0000-primer-checkov.md](../checkov/notes/0000-primer-checkov.md), [2026-05-27-checkov-quickstart-trip-ups.md](../checkov/notes/2026-05-27-checkov-quickstart-trip-ups.md)
- **docs** (5): [checkov-integration-patterns.md](../checkov/docs/checkov-integration-patterns.md), [checkov-ai-infrastructure-checks.md](../checkov/docs/checkov-ai-infrastructure-checks.md)
...
- **templates** (8): [multi-iac-scan-project](../checkov/templates/multi-iac-scan-project/), [reusable-workflow-custom-policies](../checkov/templates/reusable-workflow-custom-policies/)
...
- **templates** (6): [sbom-pipeline-scaffold](../syft/templates/sbom-pipeline-scaffold/)
- **docs** (5): [enterprise-registry-auth-caching-patterns.md](../syft/docs/enterprise-registry-auth-caching-patterns.md), [sbom-output-formats-reference.md](../syft/docs/sbom-output-formats-reference.md)
- _…and more under `syft/` — browse the folder._

## Grype · 20 files
- **primer:** [0000-primer-grype.md](../grype/notes/0000-primer-grype.md)
- **notes** (4): most recent → [0000-primer-grype.md](../grype/notes/0000-primer-grype.md), [2026-06-08-first-grype-scan.md](../grype/notes/2026-06-08-first-grype-scan.md), [2026-06-04-grype-quickstart-trip-ups.md](../grype/notes/2026-06-04-grype-quickstart-trip-ups.md)
- **scripts** (8): [minimal-grype-scan.sh](../grype/scripts/minimal-grype-scan.sh), [ci-ready-grype-scan.sh](../grype/scripts/ci-ready-grype-scan.sh), [grype-end-to-end-scan-pipeline.sh](../grype/scripts/grype-end-to-end-scan-pipeline.sh)
...
- **notes** (3): most recent → [0000-primer-semgrep.md](../semgrep/notes/0000-primer-semgrep.md), [2026-05-26-install-semgrep-pitfalls.md](../semgrep/notes/2026-05-26-install-semgrep-pitfalls.md), [2026-05-25-install-semgrep.md](../semgrep/notes/2026-05-25-install-semgrep.md)
- **docs** (5): [semgrep-rule-writing-reference.md](../semgrep/docs/semgrep-rule-writing-reference.md), [semgrep-rule-performance-optimization.md](../semgrep/docs/semgrep-rule-performance-optimization.md)
...
- **configs** (3): [2026-07-15-first-config.tf](../terraform/configs/2026-07-15-first-config.tf), [2026-08-04-first-configuration.hcl](../terraform/configs/2026-08-04-first-configuration.hcl), [multi-environment-workspaces-variables.hcl](../terraform/configs/multi-environment-workspaces-variables.hcl)
- _…and more under `terraform/` — browse the folder._

## Falco · 13 files
- **primer:** [0000-primer-falco.md](../falco/notes/0000-primer-falco.md)
- **notes** (4): most recent → [0000-primer-falco.md](../falco/notes/0000-primer-falco.md), [2026-07-19-explore-falco-cli-rules-events-output.md](../falco/notes/2026-07-19-explore-falco-cli-rules-events-output.md), [2026-06-15-falco-rules-macros-lists.md](../falco/notes/2026-06-15-falco-rules-macros-lists.md)
...
- _…and more under `falco/` — browse the folder._

## CodeQL · 12 files
- **primer:** [0000-primer-codeql.md](../codeql/notes/0000-primer-codeql.md)
- **notes** (3): most recent → [0000-primer-codeql.md](../codeql/notes/0000-primer-codeql.md), [2026-06-14-codeql-datalog-gotchas.md](../codeql/notes/2026-06-14-codeql-datalog-gotchas.md)
...
- **notes** (4): most recent → [0000-primer-gitguardian.md](../gitguardian/notes/0000-primer-gitguardian.md), [2026-06-14-first-secrets-scan-repo.md](../gitguardian/notes/2026-06-14-first-secrets-scan-repo.md), [2026-06-13-ggshield-quickstart-trip-ups.md](../gitguardian/notes/2026-06-13-ggshield-quickstart-trip-ups.md)
...
- **notes** (3): most recent → [0000-primer-vault.md](../vault/notes/0000-primer-vault.md), [2026-06-15-vault-getting-started-trip-ups.md](../vault/notes/2026-06-15-vault-getting-started-trip-ups.md), [2026-06-05-install-vault-and-explore-cli.md](../vault/notes/2026-06-05-install-vault-and-explore-cli.md)
...
- _…and more under `dependabot/` — browse the folder._

## Snyk · 10 files
- **primer:** [0000-primer-snyk.md](../snyk/notes/0000-primer-snyk.md)
- **notes** (4): most recent → [0000-primer-snyk.md](../snyk/notes/0000-primer-snyk.md), [2026-06-14-first-vulnerability-scan.md](../snyk/notes/2026-06-14-first-vulnerability-scan.md), [2026-06-08-install-snyk-first-test.md](../snyk/notes/2026-06-08-install-snyk-first-test.md)
...
- **notes** (4): most recent → [0000-primer-cosign.md](../cosign/notes/0000-primer-cosign.md), [2026-06-22-cosign-getting-started-trip-ups.md](../cosign/notes/2026-06-22-cosign-getting-started-trip-ups.md), [2026-06-14-install-cosign-generate-first-keypair.md](../cosign/notes/2026-06-14-install-cosign-generate-first-keypair.md)
...
- **notes** (3): most recent → [0000-primer-opa.md](../opa/notes/0000-primer-opa.md), [2026-06-15-opa-getting-started-trip-ups.md](../opa/notes/2026-06-15-opa-getting-started-trip-ups.md), [2026-06-06-install-opa-repl.md](../opa/notes/2026-06-06-install-opa-repl.md)
...
- **notes** (5): most recent → [0000-primer-terrascan.md](../terrascan/notes/0000-primer-terrascan.md)
...
- **notes** (3): most recent → [0000-primer-github-actions.md](../github-actions/notes/0000-primer-github-actions.md), [2026-08-04-explore-github-actions.md](../github-actions/notes/2026-08-04-explore-github-actions.md), [2026-07-14-explore-github-actions.md](../github-actions/notes/2026-07-14-explore-github-actions.md)
...
- **notes** (3): most recent → [0000-primer-git.md](../git/notes/0000-primer-git.md), [2026-07-12-install-git-identity-first-commit.md](../git/notes/2026-07-12-install-git-identity-first-commit.md), [2026-07-04-git-branching-merge-confusions.md](../git/notes/2026-07-04-git-branching-merge-confusions.md)
...
- **notes** (5): most recent → [0000-primer-argocd.md](../argocd/notes/0000-primer-argocd.md), [2026-08-01-verify-readme-layout.md](../argocd/notes/2026-08-01-verify-readme-layout.md), [2026-07-31-verify-readme-layout.md](../argocd/notes/2026-07-31-verify-readme-layout.md)
...
- **notes** (2): most recent → [0000-primer-defectdojo.md](../defectdojo/notes/0000-primer-defectdojo.md), [2026-08-04-explore-defectdojo-ui.md](../defectdojo/notes/2026-08-04-explore-defectdojo-ui.md)
