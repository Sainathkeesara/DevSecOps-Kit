...
- **OWASP ZAP** — DAST tool for web application security testing. Baseline, spider, and active scan modes. [Primer](../zap/notes/0000-primer-zap.md) | [Install and first baseline scan](../zap/notes/2026-09-05-install-zap-first-baseline-scan.md) | [Baseline scan script](../zap/scripts/zap-baseline-scan.sh) | [DAST workflow](../zap/scripts/dast-workflow-from-scratch.sh)
