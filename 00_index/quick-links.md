...
- [ZAP DAST integration scaffold with Dependabot (template)](../zap/templates/zap-dast-integration-scaffold/) — GitHub Actions scaffold with Automation Framework plans and Dependabot for ZAP image updates
