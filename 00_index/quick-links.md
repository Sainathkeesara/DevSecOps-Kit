...
- [Terrascan getting-started tutorial — what tripped me up (Docker + plan scan)](../terrascan/notes/2026-07-10-terrascan-getting-started-trip-ups.md) — L2 notes: Docker install, Terraform plan scanning, volume mount gotchas, and CI gating
...
- [ZAP DAST scaffold with Automation Framework](../zap/templates/zap-dast-integration-scaffold/) — GitHub Actions workflow + Automation Framework plan for CI-integrated DAST scanning
...
## Runtime security with Falco
 ...
 - [Comparing syscall vs tracepoint rules for container monitoring](../falco/docs/syscall-vs-tracepoint-rules.md) — Syscall vs tracepoint rule sources, coverage, and performance tradeoffs
  - [How I tuned Falco rules to reduce noisy alerts](../falco/docs/tuned-falco-rules-noise-reduction.md) — L3 docs: baseline stats, exception rules, priority tuning, and verification
